...
if("TRUE" STREQUAL "TRUE")
  set(ball_detector_SOURCE_PREFIX /home/shared/catkin_ws/src/ball_detector)
  set(ball_detector_DEVEL_PREFIX /home/shared/catkin_ws/devel)
  ...
  set(ball_detector_INSTALL_PREFIX /home/shared/catkin_ws/install)
...
if(NOT "/home/shared/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'indigo <indigo@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ball_detector' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ball_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shared/catkin_ws/src/ball_detector/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ball_detector_NUM_DUMMY_TARGETS)
      set(ball_detector_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ball_detector::wrapped-linker-option${ball_detector_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ball_detector_NUM_DUMMY_TARGETS "${ball_detector_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ball_detector::wrapped-linker-option${ball_detector_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ball_detector_LIBRARIES "${interface_target_name}")
...
set(ball_detector_EXPORTED_TARGETS "ball_detector_generate_messages_cpp;ball_detector_generate_messages_eus;ball_detector_generate_messages_lisp;ball_detector_generate_messages_nodejs;ball_detector_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ball_detector_dep}_FOUND)
      find_package(${ball_detector_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ball_detector_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
